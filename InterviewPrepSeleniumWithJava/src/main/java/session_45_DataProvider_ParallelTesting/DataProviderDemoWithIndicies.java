...
public class DataProviderDemoWithIndicies {
    WebDriver driver;
    ...
    @DataProvider(name = "dp",indices = {1})//in this i have given 1 so
    //{"pavanoI123@gmail.com", "test@123"}, will be sent as the it starts from 0
    // or you can send like indices = {1,2,3}
